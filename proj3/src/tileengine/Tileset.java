...
public class Tileset {
    ...
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", "data/Walls/Stonewall_Texture.jpg", 1);
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black, "floor","data/Walls/Brick_Texture.png", 2);
    ...
    public static final TETile WATER = new TETile('≈', Color.blue, Color.black, "water", "data/Walls/Bluerock_Texture.jpg",5);
    ...
    public static final TETile PERSON = new TETile('P', Color.white, Color.black, "person", 13);
}
