...
public class TestRedBlackTree {
    ...
    public void testBasicRotateLeft() {
        // Insert 10, 9, 8
        RedBlackTree<Integer> leftBtree = new TestableRedBlackTree();
        assertThat(leftBtree.root).isNull();
        ...
        RedBlackTree.RBTreeNode<Integer> newRoot = leftBtree.rotateLeft(node1);
        assertThat(newRoot.item).isEqualTo(9);
        assertThat(newRoot.right.item).isEqualTo(10);
        assertThat(newRoot.left.item).isEqualTo(8);
    }
